...
public class OllirTest {
    ...
    @Test
    public void compileInstant(){
        testJmmCompilation("pt/up/fe/comp/cp2/ollir/CompileInstant.jmm", (classunit) -> {
    ...
    @Test
    public void compilePutaco2(){
        testJmmCompilation("pt/up/fe/comp/cp2/ollir/CompilePutaco2.jmm", (classunit) -> {
        });
    }
